export default [
  ...
  },
  {
    ...
    "who": "住宅金融支援機構",
    "additional_url_key": "",
    "description": "災害で住宅が「全壊」、「大規模・中規模半壊」または「半壊」した旨の「り災証明書」を交付されている方が利用できる住宅復旧のための建設資金または購入資金に対する融資です。"
  },
  {
    "name": "災害復興住宅融資（補修）",
    "conditions": "家屋補修=はい",
  ...
  },
  {
    ...
    "who": "市（各区役所健康福祉課）",
    "additional_url_key": "市町村",
    "description": "(1)母子家庭又は父子家庭となって7年未満の母又は父に対し、月額10.8万円×3ヶ月を限度として生活の安定・継続に要する資金を貸し付けます。(2)住宅が全壊・半壊（大規模・中規模含む）、全焼・半焼、流出、床上浸水等の被害を受けた母子・父子・寡婦世帯を対象に、補修、保全、増築、改築等に必要な経費を200万円まで貸し付けます。(3)住居の移転に必要な資金を貸し付けます。（限度額26万円）"
  },
  {
    "name": "教科書等の無償給与",
    "conditions": "学用品=はい",
  ...
  },
  {
    ...
    "who": "NHK",
    "additional_url_key": "",
    "description": "受信契約の住所の建物が、半壊（大規模・中規模含む）・半焼又は床上浸水以上程度の被害を受けた方について、受信料が一定期間免除されることがあります。"
  },
  {
  ...
  },
  {
    ...
    "conditions": "損壊状況=半壊（大規模・中規模含む）,損壊状況=準半壊/市町村=新潟市",
    "additional_state": "",
    "who": "市（公共建築課）",
    "additional_url_key": "市町村",
  ...
  {
    "name": "被災者生活再建支援制度",
    "conditions": "損壊状況=全壊,損壊状況=半壊（大規模・中規模含む）,損壊状況=準半壊/市町村=氷見市,県=石川県",
    "additional_state": "",
    "who": "市",
    "additional_url_key": "市町村",
  ...
  {
    "name": "応急仮設住宅（建設型）",
    "conditions": "損壊状況=全壊,損壊状況=半壊（大規模・中規模含む）/市町村=穴水町",
    "additional_state": "",
    "who": "市",
    "additional_url_key": "市町村",
