export default [
  {
    ...
    "description": "住宅が被害を受けて居住困難となった方の緊急避難先として市営・県営住宅を無償提供します。（※2019/11/22現在、市営住宅は受付終了）"
  },
  {
    "name": "賃貸型応急住宅",
    "conditions": "家屋被災=はい",
  ...
  },
  {
    ...
    "who": "市（地域福祉課）・県",
    "additional_url_key": "市町村",
    "description": "住宅または人が被害を受けた世帯または世帯員に対して見舞金を支給しています。"
  },
  {
    "name": "児童扶養手当の支給制限解除等",
    "conditions": "家屋被災=はい",
  ...
  },
  {
    ...
    "who": "市（都市整備課）",
    "additional_url_key": "市町村",
    "description": "被災した住宅について必要最小限の修理の補助（最大70.6万円）を行うことで、被災者が引き続き元の住宅に住むことができるように支援する制度です。"
  },
  {
    "name": "母子父子寡婦福祉資金（生活資金貸付）",
    "conditions": "一人親=はい",
    "additional_state": "",
    "who": "市（各区役所健康福祉課）",
    "additional_url_key": "市町村",
    "description": "母子家庭又は父子家庭となって7年未満の母又は父に対し、月額10.8万円×3ヶ月を限度として生活の安定・継続に要する資金を貸し付けます。"
  },
  {
    "name": "母子父子寡婦福祉資金（住宅資金貸付）",
    "conditions": "一人親=はい",
    "additional_state": "",
    "who": "市（各区役所健康福祉課）",
    "additional_url_key": "市町村",
    "description": "住宅が全壊・半壊、全焼・半焼、流出、床上浸水等の被害を受けた母子・父子・寡婦世帯を対象に、補修、保全、増築、改築等に必要な経費を200万円まで貸し付けます。"
  },
  {
    "name": "母子父子寡婦福祉資金（転宅資金貸付）",
    "conditions": "一人親=はい",
    "additional_state": "",
    "who": "市（各区役所健康福祉課）",
    "additional_url_key": "市町村",
    "description": "住居の移転に必要な資金を貸し付けます。（限度額26万円）"
  },
  {
    "name": "災害障害見舞金",
    "conditions": "見舞金=はい",
  ...
  {
    "name": "特別支援学校等への就学奨励事業",
    "conditions": "特別支援学校=はい",
    "additional_state": "",
    "who": "市（障がい者支援課）",
    "additional_url_key": "市町村",
    "description": "被災により新たに特別支援教育就学奨励費事業の対象となった幼児、児童又は生徒の保護者を対象に通学費、学用品等を援助します。"
  },
  {
    "name": "特別障害者手当の特例",
    "conditions": "損壊状況=半壊/障害者=はい,損壊状況=全壊/障害者=はい,",
    "additional_state": "",
    "who": "市（障がい者支援課）",
    "additional_url_key": "市町村",
    "description": "災害により住宅・家財などの財産の価格のおおむね1/2以上の損害を受けた場合には、所得制限の特例措置を適用します。"
  },
  {
    "name": "福祉用具の再貸与・再購入",
    "conditions": "介護者=はい,",
    ...
    "who": "市（介護保険課）",
    "additional_url_key": "市町村",
    "description": "被災前に使用していた福祉用具・特定福祉用具が破損などをした場合は、再度貸与を受ける、または再度同一の福祉用具を購入することができます。※負担割合に応じた自己負担が必要です。"
  },
  {
    "name": "障がい者の福祉用具の再給付",
    ...
    "who": "市（障がい者支援課）",
    "additional_url_key": "市町村",
    "description": "災害により障がい者の福祉用具が使用できなくなった方に、用具の再給付を行うことができます。"
  },
  {
    "name": "小・中学生の就学援助措置",
    "conditions": "就学資金=はい",
  ...
  },
  {
    ...
    "who": "市（市民税課、財務部資産税課)",
    "additional_url_key": "市町村",
    "description": "土地・住宅・家財・農作物に被害を受けた方に対し、固定資産税・都市計画税・住民税の減免が実施される場合があります。"
  },
  {
    "name": "国税の減免・猶予",
    "conditions": "損壊状況=全壊,損壊状況=半壊",
  ...
  },
  {
    ...
    "additional_url_key": "市町村",
    "description": "災害により住宅・家財などが著しい損害を受けた方の国民健康保険税を減免します。※所得要件があります。"
  },
  {
    "name": "国民健康保険一部負担金（窓口負担）の減免等",
    "conditions": "国保=はい",
    "additional_state": "",
    "who": "市（各区役所区民生活課・窓口サービス課）",
    "additional_url_key": "市町村",
  ...
  },
  {
    ...
    "who": "市（各区役所区民生活課・窓口サービス課）",
    "additional_url_key": "市町村",
    "description": "災害により住宅・家財などが著しい損害を受けた方の介護保険料を減免します。"
  },
  {
    "name": "介護保険に係る利用者負担額の減免等",
    "conditions": "介護保険=はい",
    "additional_state": "",
    "who": "市（各区役所健康福祉課）",
    "additional_url_key": "市町村",
    "description": "災害等により住宅等に著しい損害を受けた方で介護保険のサービスを利用したときの１～３割負担が困難となった方について、一定期間、利用者負担額を減免することができます。"
  },
  {
    "name": "後期高齢者医療保険料の減免",
    "conditions": "後期高齢者=はい",
    ...
    "who": "市（各区役所区民生活課・窓口サービス課）",
    "additional_url_key": "市町村",
    "description": "災害により住宅・家財などが著しい損害を受けた方の後期高齢者医療保険料を減免します。※所得要件があります。"
  },
  {
    "name": "後期高齢者医療の一部負担金（窓口負担）の減免・徴収猶予",
    "conditions": "後期高齢者=はい",
    "additional_state": "",
    "who": "市（各区役所区民生活課・窓口サービス課）",
    "additional_url_key": "市町村",
    "description": "災害により生活が困窮し、一部負担金の支払いが困難な場合、被害状況に応じ一部負担金の減免又は徴収猶予を受けられます。※所得要件があります。"
  },
  {
    "name": "医療機関での負担金免除",
    ...
    "who": "各健康保険組合",
    "additional_url_key": "",
    "description": "健康保険等の被保険者等について、窓口負担の減免措置が講じられる場合があります。"
  },
  {
  ...
  {
    "name": "年金担保貸付事業・労災年金担保貸付事業",
    "conditions": "高齢融資=はい",
    "additional_state": "",
    "who": "独立行政法人 福祉医療機構",
    "additional_url_key": "",
    "description": "国民年金、厚生年金保険または労働者災害補償保険の年金を担保として融資することが法律で唯一認められた制度です。保健・医療、介護・福祉、住宅改修、冠婚葬祭、生活必需物品の購入などの支出のために一時的に小口の資金が必要な場合にご利用いただけます。"
  },
  {
    "name": "恩給・共済年金担保融資",
    "conditions": "高齢融資=はい",
    ...
    "who": "日本政策金融公庫",
    "additional_url_key": "",
    "description": "恩給等を担保に、教育費や居住関係費、事業資金等を融資するものです。"
  },
  {
    "name": "NHK受信料の免除",
  ...
  {
    "name": "生活困窮者自立支援制度",
    "conditions": "家計急変=はい,家屋被災=はい,人的被害=はい",
    "additional_state": "",
    "who": "都道府県・市町村",
    "additional_url_key": "",
