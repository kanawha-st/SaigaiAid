export default [
  ...
  {
    "name": "災害援護資金貸付",
    "conditions": "損壊状況=全壊,損壊状況=半壊（大規模・中規模含む）,世帯主怪我=はい",
    "additional_state": "",
    "who": "市",
    "additional_url_key": "市町村",
  ...
  {
    "name": "住民税,固定資産税の減免",
    "conditions": "損壊状況=全壊,損壊状況=半壊（大規模・中規模含む）",
    "additional_state": "",
    "who": "市",
    "additional_url_key": "市町村",
  ...
  },
  {
    ...
    "who": "市",
    "additional_url_key": "市町村",
    "description": "災害により住宅・家財などが著しい損害を受けた方で、保険税の支払いが困難となった方について、国民健康保険税を減免または支払いを猶予します。（罹災証明書の提示は必要ありません）。"
  },
  {
    "name": "国民健康保険の一部負担金（窓口負担）の減免・猶予",
    "conditions": "国保=はい/市町村=富山県/損壊状況=全壊,損壊状況=半壊（大規模・中規模含む）",
    "additional_state": "",
    "who": "市",
    "additional_url_key": "市町村",
    "description": "医療機関を受診した際に支払う一部負担金（窓口負担）が減免・猶予される場合があります。"
  },
  {
    "name": "医療機関等の受診費用免除など【石川県】",
    "conditions": "損壊状況=半壊（大規模・中規模含む）,損壊状況=全壊,世帯主収入=はい,浸水=はい/市町村=金沢市,市町村=七尾市,市町村=小松市,市町村=輪島市,市町村=珠洲市,市町村=加賀市,市町村=羽咋市,市町村=能美市,市町村=津幡町,市町村=内灘町,市町村=志賀町,市町村=宝達志水町,市町村=中能登町,市町村=穴水町,市町村=能登町",
    "additional_state": "",
    "who": "市",
    "additional_url_key": "市町村",
    "description": "保険証や現金が無くても医療機関等を受診できます。"
  },
  {
  ...
  {
    "name": "後期高齢者医療の一部負担金（窓口負担）の減免・猶予",
    "conditions": "後期高齢者=はい/市町村=富山県/損壊状況=全壊,損壊状況=半壊（大規模・中規模含む）",
    "additional_state": "",
    "who": "市",
    "additional_url_key": "市町村",
    "description": "医療機関を受診した際に支払う一部負担金（窓口負担）が減免・猶予される場合があります。"
  },
  {
    ...
    "conditions": "損壊状況=半壊（大規模・中規模含む）,損壊状況=全壊,世帯主収入=はい",
    "additional_state": "",
    "who": "各健康保険組合",
    "additional_url_key": "",
  ...
  {
    "name": "NHK受信料の免除",
    "conditions": "損壊状況=全壊,損壊状況=半壊（大規模・中規模含む）,損壊状況=一部損壊",
    "additional_state": "",
    "who": "NHK",
    "additional_url_key": "",
  ...
  },
  {
    ...
    "who": "市",
    "additional_url_key": "市町村",
    "description": "災害により被害を受け納税が困難となった場合に、申告・納税の期限を延長できます。"
  },
  {
    "name": "国民年金保険料の免除等",
    "conditions": "年金＝はい",
  ...
  {
    "name": "保育料の減免",
    "conditions": "保育園=はい/損壊状況=全壊,損壊状況=半壊（大規模・中規模含む）,損壊状況=準半壊",
    "additional_state": "",
    "who": "市",
    "additional_url_key": "市町村",
  ...
  },
  {
    ...
    "conditions": "高等教育＝はい/損壊状況=全壊,損壊状況=半壊（大規模・中規模含む）,床上浸水=はい",
    "additional_state": "",
    "who": "日本学生支援機構（JASSO）",
    "additional_url_key": "",
  ...
  {
    "name": "NHK受信料の免除",
    "conditions": "損壊状況=全壊,損壊状況=半壊（大規模・中規模含む）,損壊状況=一部損壊浸水",
    "additional_state": "",
    "who": "NHK",
    "additional_url_key": "",
    "description": "受信契約の住所の建物が、半壊・半焼又は床上浸水以上程度の被害を受けた方について、受信料が一定期間免除されることがあります。"
  ...
  },
  {
    ...
    "conditions": "障害者=はい,障害児童=はい/市町村=新潟市",
    "additional_state": "",
    "who": "市",
    "additional_url_key": "市町村",
    "description": "おおむね1/2以上の財産が被災した場合に、所得制限により支給停止となっている場合でも被災状況により支給停止を解除するなどします。"
  ...
  {
    "name": "日常生活に必要な最小限度の部分の修理（応急修理）",
    "conditions": "損壊状況=半壊（大規模・中規模含む）,損壊状況=準半壊",
    "additional_state": "",
    "who": "市",
    "additional_url_key": "市町村",
    "description": "被災した住宅の居室、台所、トイレなど日常生活に不可欠な最小限度の部分の応急的な修理について、修理費用を新潟市が直接業者に支払います。（限度額：半壊以上706,000円、準半壊343,000円）"
  },
  {
    "name": "市営住宅",
    "conditions": "家屋被災=はい",
  ...
  {
    "name": "被災者生活再建支援制度",
    "conditions": "損壊状況=全壊,損壊状況=半壊（大規模・中規模含む）,損壊状況=準半壊/県=富山県,県=石川県",
    "additional_state": "",
    "who": "市",
    "additional_url_key": "市町村",
  ...
  {
    "name": "公費解体（半壊対象）",
    "conditions": "損壊状況=半壊（大規模・中規模含む）/市町村=珠洲市",
    "additional_state": "",
    "who": "市",
    "additional_url_key": "市町村",
  ...
  {
    "name": "応急仮設住宅（建設型）",
    "conditions": "損壊状況=全壊,損壊状況=半壊/市町村=穴水町,市町村=珠洲市",
    "additional_state": "",
    "who": "市",
    "additional_url_key": "市町村",
  ...
  },
  {
    ...
    "who": "市",
    "additional_url_key": "市町村",
    "description": "地震により所有する軽自動車が被害を受けて使用できなくなった場合、申立てをして課税されないことにできます。"
  },
  {
    "name": "給食費の減免",
    "conditions": "小中学生=はい/市町村=珠洲市",
    "additional_state": "",
    "who": "市",
    "additional_url_key": "市町村",
    "description": "給食の提供ができるまで、給食費は不要です。"
  },
  {
    "name": "義援金",
    "conditions": "市町村=輪島市,市町村=珠洲市,市町村=七尾市,市町村=穴水市,市町村=能登町,市町村=志賀町",
    "additional_state": "",
    "who": "市",
    "additional_url_key": "市町村",
    "description": "全住民に1人5万円ずつ配分。死者・行方不明者の家族には災害弔慰金としてさらに20万円を配分。住宅被害については全壊は20万円、半壊は損壊の程度に応じて5万〜15万円を配分。（受付準備中）"
  },
  {
    "name": "災害見舞金",
    "conditions": "家屋被災=はい,人的被害＝はい",
    ...
    "who": "市",
    "additional_url_key": "市町村",
    "description": "人や住宅の被害の程度に応じて災害見舞金が支給されます。※市町村により対象条件や金額が異なります。"
  },
  {
    "name": "被災者住宅修理支援事業",
    "conditions": "家屋被災=はい/市町村=上越市",
    "additional_state": "",
    "who": "市",
    "additional_url_key": "市町村",
    "description": "住宅応急修理制度の対象とならない 住宅及び附属屋の被災箇所の修理を支援する 事業 を実施する予定です。罹災 証明書は不要のほか、既に修理を完了した方も対象とする 予定です 。"
  },
  {
    "name": "がけ地の災害防止",
    "conditions": "市町村=宝達志水町",
    "additional_state": "",
    "who": "市",
    "additional_url_key": "市町村",
    "description": "個人が所有する「がけ地等」による災害の未然防止、また、既に発生したがけ崩れの被害拡大を防止するために行う工事の経費を一部補助します。"
  },
  {
    "name": "被災した宅地の復旧支援",
    "conditions": "家屋被災=はい/市町村=宝達志水町",
    "additional_state": "",
    "who": "市",
    "additional_url_key": "市町村",
    "description": "被災者が行う宅地の復旧工事等に要する費用の一部を補助します。"
  },
  {
    "name": "マイホーム取得奨励金",
    "conditions": "家屋被災=はい/市町村=宝達志水町",
    ...
    "who": "市",
    "additional_url_key": "市町村",
    "description": "能登半島地震により住宅の被害を受けられた方の新たな住宅取得、再建の一助とするため、奨励金を支給します。"
  },
  {
    "name": "ケーブルテレビ利用料金等の減免",
    "conditions": "家屋被災=はい/市町村=宝達志水町",
    "additional_state": "",
    "who": "市",
    "additional_url_key": "市町村",
    "description": "3月までの利用料免除、転居を余儀なくされた場合の新規加入費用免除、解約または休止および休止後の再開費用免除等が適用される場合があります。"
  },
  {
    "name": "準半壊住家等の解体費補助",
    "conditions": "損壊状況=全壊,損壊状況=半壊（大規模・中規模含む）,損壊状況=準半壊/市町村=小矢部市",
    "additional_state": "",
    "who": "市",
    "additional_url_key": "市町村",
    "description": "住家被害認定調査にて「準半壊」の判定を受けた、公費解体等の支援対象外の住家等において、所有者の判断により解体を行う場合に掛かる費用を補助するもの。"
  },
  {
    "name": "住宅災害見舞金の支給",
    "conditions": "家屋被災=はい/市町村=小矢部市",
    "additional_state": "",
    "who": "市",
    "additional_url_key": "市町村",
    "description": "市内被災者を支援するため、被害区分に応じて、被災世帯に対し住宅災害見舞金を支給するもの（県の見舞金に上乗せ）。全壊世帯：10万円、半壊世帯：5万円（大規模半壊、中規模半壊、半壊）、一部破損世帯：1万円（準半壊、一部損壊）"
  },
  {
    "name": "知事見舞金",
    "conditions": "損壊状況=全壊,損壊状況=半壊（大規模・中規模含む）/県=富山県",
    ...
    "who": "県",
    "additional_url_key": "",
    "description": "住家の全壊世帯・半壊世帯に対し、見舞金を支給するもの。支給額：全壊世帯 10 万円、半壊世帯5万円。"
  }
];